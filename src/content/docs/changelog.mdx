...
Some of the components have been enhanced with improved animations and interactions.
...
For a complete overview of syntax changes and new features, please refer to the official Tailwind v4 documentation.
