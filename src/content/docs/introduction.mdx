...
ImooUI is a collection of fun and weird, ready-to-use components and microinteractions built (mainly) with:
...
ImooUI is open source and free to use. You can use it for personal or commercial projects.

Developed by **Imoogle Tech**, this library aims to bring innovation and fun back to web interfaces.

Contributions are welcome! If you have any ideas or suggestions, please feel free to reach out. A detailed contribution guide will be available soon.
