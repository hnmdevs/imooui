...
<InstallTabs command="shadcn@latest add &quot;https://imooui.imoogleai.xyz/r/marquee-along-svg-path.json&quot;" npx />
...
The component is really similar to the [Simple Marquee Component](https://imooui.imoogleai.xyz/docs/components/blocks/simple-marquee), and has the same features and props (and a bit more:)):
