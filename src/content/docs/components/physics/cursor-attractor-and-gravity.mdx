...
<InstallTabs command="imooui@latest add cursor-attractor-and-gravity" npx />
...
For more details on the decomposition process, refer to the poly-decomp documentation, the [Matter.js documentation](https://brm.io/matter-js/docs/classes/Bodies.html#method_fromVertices), and to the SVG path commander documentation.
