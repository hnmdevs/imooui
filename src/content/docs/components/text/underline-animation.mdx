...
<InstallTabs command="imooui@latest add underline-center" npx />
...
<InstallTabs command="imooui@latest add underline-comes-in-goes-out" npx />
...
<InstallTabs command="imooui@latest add underline-goes-out-comes-in" npx />
