...
<InstallTabs command="npx imooui@latest add component-name" npx />
...
If you prefer JavaScript instead of TypeScript, you can easily convert the code using standard conversion tools.
